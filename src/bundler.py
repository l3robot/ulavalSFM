...
# Modified by Louis-Émile Robitaille @ LERobot
# This version only find focal distance in EXIF and compile it in list.txt
...
CCD_WIDTHS = {
     ...
     "Canon Canon EOS REBEL T4i"                 : 22.3,
...
def get_images():
    ...
    if not os.path.isfile("images.txt") :
        ...
        print("Images list already created.")
